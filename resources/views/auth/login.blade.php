    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex justify-center mt-4">
            <a href="{{ route('register') }}">
                <i class="fab fa-google"></i> ¿No tienes cuenta?
            </a>
        </div>
        ...
        <!-- **********boton login GOOGLE -->
        <div class="flex justify-center mt-4">
            <a href="/google-auth/redirect" class="inline-flex items-center px-4 py-2 bg-blue-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-yellow-500 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150">
