...
<div class="container">
        ...
        <div class="content">
            ...
            <p>Queremos recordarte que solo te faltan {{$diasRestantes }} días para que tu <span>{{ $tipoRecordatorio }}</span> expire.</p>
            ...
            <p>Encuentra los mejores talleres de tu ciudad en nuestra web:</p>
             <!-- ESta ruta es solo para que funcione en local en producción hay que poner la url de la web  https://proyecto-final.jose-rodriguez-blanco.es-->
